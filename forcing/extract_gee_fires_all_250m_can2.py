...
if __name__ == '__main__':
    ...
    OUTFILE = folder + 'SAMPLES/fires/can_fire_multi_s2_extract_v{}.csv'.format(datetime.datetime.now().isoformat()
    ...
    can_fire = ee.FeatureCollection('users/masseyr44/shapefiles/can_fire_multi_s2')
