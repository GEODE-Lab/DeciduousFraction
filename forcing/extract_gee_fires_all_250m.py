...
if __name__ == '__main__':
    ...
    OUTFILE = folder + 'SAMPLES/fires/ak_fire_multi_extract_v{}.csv'.format(datetime.datetime.now().isoformat()
    ...
    can_fire = ee.FeatureCollection('users/masseyr44/shapefiles/Can_fire_multi_s3')
