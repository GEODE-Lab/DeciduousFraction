...
var land = ee.Image("users/masseyr44/decid/land_extent_NA"),
    ...
    decid_east_pval = ee.Image("users/masseyr44/decid/t_value_1992_2015_east_90_mosaic_lzw_pval"),
    decid_west_pval = ee.Image("users/masseyr44/decid/t_value_1992_2015_west_90_mosaic_lzw_pval"),
    tc_pval = ee.Image("users/masseyr44/decid/t_value_1992_2015_tc_mosaic_lzw_pval"),
...
var tc_mask = boreal_mask.updateMask(tc_max.gte(25)).multiply(canada_extent);
...
var tc_diff = tc2015.subtract(tc1992).updateMask(tc_mask).multiply(land).toFloat().multiply(0.01);
