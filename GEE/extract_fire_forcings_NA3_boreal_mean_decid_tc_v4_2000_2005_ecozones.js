...
var decid_udiff = ee.Image().expression('((a**2 + b**2) ** 0.5)',{'a': decid2000u.toFloat(), 'b': decid2015u.toFloat()}).updateMask(tc_mask_max).multiply(land).clip(boreal_bounds).toFloat().multiply(0.01);
