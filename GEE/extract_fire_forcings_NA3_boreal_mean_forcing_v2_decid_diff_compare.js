...
var sig_pval = pval.updateMask(pval.lte(0.05)).multiply(0).add(1).updateMask(tc_mask)
var insig_pval = pval.updateMask(pval.gt(0.05)).multiply(0).add(0).updateMask(tc_mask)
...
var sig_pval_tc = tc_pval.updateMask(tc_pval.lte(0.05)).multiply(0).add(1).updateMask(tc_mask)
var insig_pval_tc = tc_pval.updateMask(tc_pval.gt(0.05)).multiply(0).add(0).updateMask(tc_mask)
