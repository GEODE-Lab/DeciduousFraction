...
var tc_udiff = ee.Image().expression('((a**2 + b**2) ** 0.5)',{'a': tc2000u.toFloat(), 'b': tc2015u.toFloat()}).updateMask(tc_mask_max).multiply(land).multiply(0.01);
...
var decid_udiff = ee.Image().expression('((a**2 + b**2) ** 0.5)',{'a': decid2000u.toFloat().divide(2.0), 'b': decid2015u.toFloat()}).updateMask(tc_mask_max).multiply(land).clip(boreal_bounds).toFloat().multiply(0.01);
...
var fall_diff = change_calc(alb_fall2000_v2, alb_fall2015_v2).updateMask(tc_mask_max).multiply(land);
var fall_udiff = uncert_calc(alb_fall2000_v2, alb_fall2015_v2, alb_fall2000_uncert, alb_fall2015_uncert).updateMask(tc_mask_max);
...
var sum_diff = change_calc(alb_sum2000_v2, alb_sum2015_v2).updateMask(tc_mask_max).multiply(land);
var sum_udiff = uncert_calc(alb_sum2000_v2, alb_sum2015_v2, alb_fall2000_uncert, alb_fall2015_uncert).updateMask(tc_mask_max);
...
var spr_diff = change_calc(alb_spr2000_v2, alb_spr2015_v2).updateMask(tc_mask_max).multiply(land);
var spr_udiff = uncert_calc(alb_spr2000_v2, alb_spr2015_v2, alb_spr2015_uncert, alb_spr2015_uncert).updateMask(tc_mask_max);
