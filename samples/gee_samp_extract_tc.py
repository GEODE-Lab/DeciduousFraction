...
if __name__ == '__main__':
    ...
    script, infile, hostname = argv

    ee.Initialize()
    '''
    folder = 'D:/Shared/Dropbox/projects/NAU/landsat_deciduous/data/SAMPLES/tree_cover/'  ## '/home/richard/'
    infile = folder + 'hansen_tc_2010_part_1.shp'
    hostname = 'osiris'
    '''
    folder = '/home/richard/'
    OUTFILE = folder + 'gee_samp_extract_{}_v{}.csv'.format(hostname,
    ...
    for j, chunk in enumerate(feat_list_chunks):
        ...
        while i < n_sites:
            ...
            log.lprint('Time taken for site {s} ({ii} of {nn}): {t} seconds'.format(s=str(i+1),
                                                                                ii=str(site_count + 1),
                                                                                nn=str(n_samp),
                                                                       t=str(round((time2 - time1).total_seconds(),
                                                                                   1))))
