...
OUTFILE = folder + 'SAMPLES/gee_extract/' + \
    'gee_samp_extract_v{}.csv'.format(datetime.datetime.now().isoformat()
...
file7 = folder + "SAMPLES/CAN_PSP/PSP_data/CAN_PSP_v1.shp"
file8 = folder + "SAMPLES/CAN_PSP/Yukon_PSP.shp"
file9 = folder + "SAMPLES/NWT/NWT_PSP.shp"

filelist = [file1, file3, file7, file5, file6]
...
boundary_geom = Vector.get_osgeo_geom(json.dumps(boundary.getInfo()),
                                      geom_type='json')
