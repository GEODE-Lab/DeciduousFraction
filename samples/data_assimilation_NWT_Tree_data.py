...
if __name__ == '__main__':
    ...
    samp_file = "C:/Users/rm885/Dropbox/projects/NAU/landsat_deciduous/data/SAMPLES/NWT/NWT_site_tree_data.csv"
    out_file = "C:/Users/rm885/Dropbox/projects/NAU/landsat_deciduous/data/SAMPLES/NWT/NWT_site_tree_data.shp"
    log_file = "C:/Users/rm885/Dropbox/projects/NAU/landsat_deciduous/data/SAMPLES/NWT/NWT_site_tree_data.log"
    ...
    burn_attr = ogr.FieldDefn('burn_yr', ogr.OFTInteger)
    burn_attr.SetWidth(8)
    ...
    mack_vec.fields = mack_vec.fields + [site_attr, year_attr, decid_attr, age_attr]
    ...
    for index, row_obj in samp_data.iterrows():
        ...
        samp_dict = dict(zip(out_header, [site_name, site_meas_year, decid_frac, age, burn_year]))

        # update vector
        mack_vec.add_feat(geom=geom,
                          attr=samp_dict)
