#!/bin/bash
#SBATCH --job-name=mos2005
#SBATCH --time=23:59:00
#SBATCH --cpus-per-task=1
#SBATCH --mem=128000
#SBATCH --partition=all
#SBATCH --output=/home/rm885/slurm-jobs/gdal_mosaic_2005_tif_%j.out
...
files=(${datadir}*_2005-*prediction.tif)
echo 'Found '${#files[*]}' prediction files'

mosaic=$datadir'ABoVE_median_SR_NDVI_boreal_2005_prediction.tif'
temp=$datadir'ABoVE_median_SR_NDVI_boreal_2005_prediction_temp_2.tif'
compmosaic=$datadir'ABoVE_median_SR_NDVI_boreal_2005_prediction_vis_nd_2.tif'
...
# list of input filess
files=(${datadir}*_2005-*uncertainty.tif)
echo 'Found '${#files[*]}' uncertainty files'

mosaic=$datadir'ABoVE_median_SR_NDVI_boreal_2005_uncertainty.tif'
temp=$datadir'ABoVE_median_SR_NDVI_boreal_2005_uncertainty_temp_2.tif'
compmosaic=$datadir'ABoVE_median_SR_NDVI_boreal_2005_uncertainty_vis_nd_2.tif'
