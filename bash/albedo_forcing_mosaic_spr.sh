#!/bin/bash
#SBATCH --job-name=spr_alb
#SBATCH --time=18:59:00
#SBATCH --cpus-per-task=1
#SBATCH --mem=64000
#SBATCH --partition=all
#SBATCH --output=/home/rm885/slurm-jobs/spr_alb_mosaic_2015_new_tif_%j.out
...
datadir='/scratch/rm885/gdrive/sync/decid/decid_tc_albedo_predict_spr/'
