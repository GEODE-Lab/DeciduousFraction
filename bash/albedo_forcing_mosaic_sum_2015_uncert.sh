#!/bin/bash
#SBATCH --job-name=sum_15mu
#SBATCH --time=18:59:00
#SBATCH --cpus-per-task=1
#SBATCH --mem=64000
#SBATCH --partition=all
#SBATCH --output=/home/rm885/slurm-jobs/sum_alb_mosaic_2015_uncert_tif_%j.out
...
mosaic=$datadir'decid_tc_2015_sum_albedo_uncert.tif'
temp=$datadir'decid_tc_2015_sum_albedo_temp_uncert.tif'
compmosaic=$datadir'decid_tc_2015_sum_albedo_vis_uncert.tif'
