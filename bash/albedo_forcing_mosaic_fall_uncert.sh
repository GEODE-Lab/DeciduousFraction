#!/bin/bash
#SBATCH --job-name=fal_albu
#SBATCH --time=18:59:00
#SBATCH --cpus-per-task=1
#SBATCH --mem=64000
#SBATCH --partition=all
#SBATCH --output=/home/rm885/slurm-jobs/fall_alb_uncert_mosaic_2015_new_tif_%j.out
...
mosaic=$datadir'decid_tc_2000_fall_albedo.tif'
temp=$datadir'decid_tc_2000_fall_albedo_temp.tif'
compmosaic=$datadir'decid_tc_2000_fall_albedo_vis.tif'
...
mosaic=$datadir'decid_tc_2015_fall_albedo.tif'
temp=$datadir'decid_tc_2015_fall_albedo_temp.tif'
compmosaic=$datadir'decid_tc_2015_fall_albedo_vis.tif'
