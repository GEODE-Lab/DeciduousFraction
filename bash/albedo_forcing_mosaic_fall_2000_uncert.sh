#!/bin/bash
#SBATCH --job-name=fall_00u
#SBATCH --time=18:59:00
#SBATCH --cpus-per-task=1
#SBATCH --mem=64000
#SBATCH --partition=all
#SBATCH --output=/home/rm885/slurm-jobs/fall_alb_mosaic_2000_uncert_tif_%j.out
...
mosaic=$datadir'decid_tc_2000_fall_albedo_uncert.tif'
temp=$datadir'decid_tc_2000_fall_albedo_temp_uncert.tif'
compmosaic=$datadir'decid_tc_2000_fall_albedo_vis_uncert.tif'
