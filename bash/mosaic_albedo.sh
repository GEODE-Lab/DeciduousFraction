...
files=(${datadir}*ABoVE_img_am_2005*.tif)

mosaic=$datadir'ABoVE_decid_2005_mosaic.tif'
compmosaic=$datadir'ABoVE_decid_2005_mosaic_vis.tif'
compmosaic_byte=$datadir'ABoVE_decid_2005_mosaic_vis_byte.tif'
