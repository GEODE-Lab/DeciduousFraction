#!/bin/bash
#SBATCH --job-name=spr_albu
#SBATCH --time=18:59:00
#SBATCH --cpus-per-task=1
#SBATCH --mem=64000
#SBATCH --partition=all
#SBATCH --output=/home/rm885/slurm-jobs/spr_alb_uncert_mosaic_2015_new_tif_%j.out
...
datadir='/scratch/rm885/gdrive/sync/decid/decid_tc_albedo_predict_spr_uncert/'

# list of input filess
files=(${datadir}decid_tc_2000_layerstack*.tif)
echo 'Found '${#files[*]}' files'

mosaic=$datadir'decid_tc_2000_spr_albedo.tif'
temp=$datadir'decid_tc_2000_spr_albedo_temp.tif'
compmosaic=$datadir'decid_tc_2000_spr_albedo_vis.tif'
...
mosaic=$datadir'decid_tc_2015_spr_albedo.tif'
temp=$datadir'decid_tc_2015_spr_albedo_temp.tif'
compmosaic=$datadir'decid_tc_2015_spr_albedo_vis.tif'
