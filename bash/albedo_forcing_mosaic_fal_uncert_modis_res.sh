#!/bin/bash
#SBATCH --job-name=fal_alb_
#SBATCH --time=3:59:00
#SBATCH --cpus-per-task=1
#SBATCH --mem=24000
#SBATCH --partition=all
#SBATCH --output=/home/rm885/slurm-jobs/fal_alb_mosaic_2015_uncert_modis_res_tif_%j.out
...
mosaic=$datadir'decid_tc_2000_fal_albedo_modis_res.tif'
compmosaic=$datadir'decid_tc_2000_fal_albedo_modis_res_vis.tif'
...
mosaic=$datadir'decid_tc_2015_fal_albedo_modis_res.tif'
compmosaic=$datadir'decid_tc_2015_fal_albedo_modis_res_vis.tif'
