#!/bin/bash
#SBATCH --job-name=mos1992
#SBATCH --time=23:59:00
#SBATCH --cpus-per-task=1
#SBATCH --mem=128000
#SBATCH --partition=all
#SBATCH --output=/home/rm885/slurm-jobs/gdal_mosaic_1992_tif_%j.out
...
files=(${datadir}*_1992-*prediction.tif)
echo 'Found '${#files[*]}' prediction files'

mosaic=$datadir'ABoVE_median_SR_NDVI_boreal_1992_prediction.tif'
temp=$datadir'ABoVE_median_SR_NDVI_boreal_1992_prediction_temp_2.tif'
compmosaic=$datadir'ABoVE_median_SR_NDVI_boreal_1992_prediction_vis_nd_2.tif'
...
# list of input filess
files=(${datadir}*_1992-*uncertainty.tif)
echo 'Found '${#files[*]}' uncertainty files'

mosaic=$datadir'ABoVE_median_SR_NDVI_boreal_1992_uncertainty.tif'
temp=$datadir'ABoVE_median_SR_NDVI_boreal_1992_uncertainty_temp_2.tif'
compmosaic=$datadir'ABoVE_median_SR_NDVI_boreal_1992_uncertainty_vis_nd_2.tif'
...
outfile=$datadir${outfile_%.tif}'_250m.tif'
gdalwarp -ot Byte -tr 0.002083333 0.002083333 -t_srs 'EPSG:4326' -r bilinear -srcnodata 255 -dstnodata 255 -co COMPRESS=LZW -co BIGTIFF=YES $compmosaic $outfile 
gdaladdo -ro $outfile 2 4 8 16 32 64 128 256 --config COMPRESS_OVERVIEW LZW
