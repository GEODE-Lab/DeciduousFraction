#!/bin/bash
#SBATCH --job-name=mos2000
#SBATCH --time=23:59:00
#SBATCH --cpus-per-task=1
#SBATCH --mem=128000
#SBATCH --partition=all
#SBATCH --output=/home/rm885/slurm-jobs/gdal_mosaic_2000_tif_%j.out
...
files=(${datadir}*_2000-*prediction.tif)
echo 'Found '${#files[*]}' prediction files'

mosaic=$datadir'ABoVE_median_SR_NDVI_boreal_2000_prediction.tif'
temp=$datadir'ABoVE_median_SR_NDVI_boreal_2000_prediction_temp_2.tif'
compmosaic=$datadir'ABoVE_median_SR_NDVI_boreal_2000_prediction_vis_nd_2.tif'
...
# list of input filess
files=(${datadir}*_2000-*uncertainty.tif)
echo 'Found '${#files[*]}' uncertainty files'

mosaic=$datadir'ABoVE_median_SR_NDVI_boreal_2000_uncertainty.tif'
temp=$datadir'ABoVE_median_SR_NDVI_boreal_2000_uncertainty_temp_2.tif'
compmosaic=$datadir'ABoVE_median_SR_NDVI_boreal_2000_uncertainty_vis_nd_2.tif'
