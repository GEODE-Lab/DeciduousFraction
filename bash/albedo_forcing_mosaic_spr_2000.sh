#!/bin/bash
#SBATCH --job-name=spr_00m
#SBATCH --time=18:59:00
#SBATCH --cpus-per-task=1
#SBATCH --mem=64000
#SBATCH --partition=all
#SBATCH --output=/home/rm885/slurm-jobs/spr_alb_mosaic_2000_new_tif_%j.out
...
mosaic=$datadir'decid_tc_2000_spr_albedo_v2.tif'
temp=$datadir'decid_tc_2000_spr_albedo_temp_v2.tif'
compmosaic=$datadir'decid_tc_2000_spr_albedo_vis_v2.tif'
