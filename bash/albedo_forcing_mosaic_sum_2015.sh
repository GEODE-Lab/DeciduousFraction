...
mosaic=$datadir'decid_tc_2015_sum_albedo_v2.tif'
temp=$datadir'decid_tc_2015_sum_albedo_temp_v2.tif'
compmosaic=$datadir'decid_tc_2015_sum_albedo_vis_v2.tif'
