#!/bin/bash
#SBATCH --job-name=ls8_u_tc
#SBATCH --time=18:59:00
#SBATCH --cpus-per-task=1
#SBATCH --mem=64000
#SBATCH --partition=all
#SBATCH --output=/home/rm885/slurm-jobs/ls8_corr_tc_uncert_mosaic_2015_%j.out
...
files=(${datadir}ABoVE_median_SR_NDVI_1_2015*uncertainty.tif ${datadir}ABoVE_median_SR_NDVI_2_2015*uncertainty.tif ${datadir}ABoVE_median_SR_NDVI_3_2015*uncertainty.tif ${datadir}ABoVE_median_SR_NDVI_4_2015*uncertainty.tif ${datadir}ABoVE_median_SR_NDVI_5_2015*uncertainty.tif ${datadir}ABoVE_median_SR_NDVI_6_2015*uncertainty.tif)
echo 'Found '${#files[*]}' files'
mosaicsmall=$datadir'ls8_corr_tc_uncert_mosaic_small_2015.tif'
mosaic=$datadir'ls8_corr_tc_uncert_mosaic_2015.tif'
temp=$datadir'ls8_corr_tc_uncert_mosaic_2015_temp.tif'
compmosaic=$datadir'ls8_corr_tc_uncert_mosaic_2015_vis.tif'
