...
files=(${datadir}*ABoVE_img_am_2000*.tif)

mosaic=$datadir'ABoVE_decid_2000_mosaic.tif'
compmosaic=$datadir'ABoVE_decid_2000_mosaic_vis.tif'
compmosaic_byte=$datadir'ABoVE_decid_2000_mosaic_vis_byte.tif'
...
# background value: 0
# file format: Geotiff
gdal_merge.py -init 0 -o $mosaic -of GTiff -ps 0.000269 0.000269 -n 0.330400 -ot Float32 ${files[*]}
