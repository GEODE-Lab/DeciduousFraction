...
if __name__ == '__main__':
    ...
    geom_list = [[-162.40530107777283, 68.41236435474814],
                 [-162.40530107777283, 61.56070650054604],
                 [-140.16897295277283, 61.56070650054604],
                 [-140.16897295277283, 68.41236435474814],
                 [-162.40530107777283, 68.41236435474814]]
    geom_wkt = Vector.wkt_from_coords(geom_list, 'polygon')
    geom = Vector.get_osgeo_geom(geom_wkt)
    ...
    ras_geom_list = ras.get_bounds()
    ras_wkt = Vector.wkt_from_coords(ras_geom_list, 'polygon')
    ras_geom = Vector.get_osgeo_geom(ras_wkt)

    if ras_geom.Intersects(geom):

        print('Intersection found... Proceeding with classification')
        ...
        Opt.cprint('No intersection... Aborting!')
